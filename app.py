"""VERY IMPORTANT: If you want to export the API_KEY 
...
def articles():
    ...
    articlesResults = lookup(geo)

    # TODO
    return jsonify(articlesResults[0:5]) # Only display the first five articles
...
def search():
    ...
    rows = db.execute("SELECT * FROM virtualplaces WHERE virtualplaces MATCH :q", q=queryInput)
